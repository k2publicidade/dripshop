...
revoke all on function public.upsert_cart_item(uuid,integer,text,text) from public,anon;
grant execute on function public.upsert_cart_item(uuid,integer,text,text) to authenticated;
commit;
